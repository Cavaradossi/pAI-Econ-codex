...
This guide establishes writing standards for theoretical economics papers produced by the `pAI-Econ-codex` pipeline. It is read during Stage 10 (Manuscript Skeleton) and should be consulted throughout the writing process.
...
*Developed by Chen Zhu, Xiaolu Wang, and Weilong Zhang (pAI-Econ-codex). Based on pAI/MSc writing standards (Abdelmoneum, Beneventano, Poggio — MIT + Perseus Labs). Adapted for theoretical economics.*
